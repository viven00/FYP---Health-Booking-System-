...
include_once("NurseViewAccController.php");
include("Nurse.php");

$user = new NurseViewAccController();
?>
...
<head>
	...
	<script>
		...
		function NurseEditParticularsFunction(userID) 
		{
			location.href= "ModifyNurseAccUI.php?userID=" + userID;
		}
...
<div class="w3-content" style="max-width:1500px;margin-left:230px;overflow:hidden;margin-top:87px;">
    <div class='w3-content' style='background-color:white;max-width:1500px;height:100%;'>
        <div class='w3-container w3-content w3-padding-32' style='max-width:1500px;margin-left:20px;font-family:cardo;'>
	...
	<br></br>
		...
		<button type='button' class='btn' style="background-color:dodgerblue;color:white;font-weight:bold;" onclick='NurseEditParticularsFunction()'>Update</button>
		</div>
	</div>
</div>
</div>
