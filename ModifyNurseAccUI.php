<?php
include_once("ModifyNurseAccController.php"); // include create account Controller to call function
include("Nurse.php");
session_start();
...
function success_alert($message)
{
    ...
    echo "<script type='text/javascript'>alert('$message');window.location.href='NurseViewAccUI.php'</script>";
}
...
if (isset($_POST['submit'])) {
    ...
    $modifyUserCtrl = new ModifyNurseAccController();
