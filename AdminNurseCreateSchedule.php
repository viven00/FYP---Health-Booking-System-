...
{
    echo "<script type='text/javascript'>alert('$message');window.location.href='AdminViewDoctorSchedule.php?scheduleID + $scheduleID'</script>";
} 
else if ($profileName == 'Nurse') 
{
    echo "<script type='text/javascript'>alert('$message');window.location.href='NurseViewDoctorSchedule.php?scheduleID + $scheduleID'</script>";
}
}
...
<html>
<head>
	<title>Admin Create Doctor Schedule</title>
            ...
            <div class='w3-container w3-content w3-padding-64' style='width:500px'>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control text-center" name="doctor_name" required>
                            <option value="">All Doctors</option>
                            <?php
                            $docArray = array();
                            $docArray = $ViewSController->getDoctors();
