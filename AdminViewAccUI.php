...
include_once("AdminViewAccController.php");
include("Admin.php");

$user = new AdminViewAccController();
?>
...
<head>
    ...
    <script>
		...
		function AdminEditParticularsFunction() 
		{
...
<div class="w3-content" style="max-width:1500px;margin-left:230px;overflow:hidden;margin-top:87px;">
    <div class='w3-content' style='background-color:#ebf5fb;max-width:1500px;height:100%;'>
	...
	<br></br>
		...
		<button type='button' class='btn' style="background-color:dodgerblue;color:white;font-weight:bold;" onclick='AdminEditParticularsFunction()'>Update</button>
		</div>
	</div>
</div>
</div>
