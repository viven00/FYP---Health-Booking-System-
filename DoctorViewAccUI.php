...
<head>
    ...
    <script>
		function DoctorEditParticularsFunction(userID) 
		{
			location.href= "ModifyDoctorAccUI.php?userID=" + userID;
		}
...
<div class="w3-content" style="max-width:1500px;margin-left:230px;overflow:hidden;margin-top:87px;">
	...
	<br></br>
		...
		<button type='button' class='btn' style="background-color:dodgerblue;color:white;font-weight:bold;" onclick='DoctorEditParticularsFunction()'>Update</button>
		</div>
	</div>
</div>
</div>
