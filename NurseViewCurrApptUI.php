<?php
include_once("NurseViewCurrApptController.php");
...
$currAppt = new NurseViewCurrApptController();
...
<div class="w3-content" style="max-width:1300px;margin-top:87px;margin-left:215px;overflow:hidden;">
	...
	<div class="table-responsive" style="height:500px;width:1200px;">
		...
		if (isset($_POST['search'])) {
			$result = $currAppt->NurseGetCurrAppt($_POST['medicalField'], $_POST['doctor'], $_POST['appointmentDate']);
		} else
			$result = $currAppt->NurseGetCurrAppt(null, null, null,null);
