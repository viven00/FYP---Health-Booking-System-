...
include_once("DoctorViewIndvMRController.php");
include "Doctor.php";
...
<body>
    <div id="printableArea" class="w3-content" style="max-width:1300px;margin-left:230px;overflow:scroll;background-color:#ebf5fb;height:1200px;margin-top:87px;">
        <div class='w3-content' style='max-width:750px;height:1000px;background-color:white;margin-top:50px;'>
            <div class='w3-container w3-content w3-padding-32' style='max-width:1000px;font-size:18px;font-family:Helvatica;'>
                ...
                <?php
                        ...
                        $viewDetails = new DoctorViewIndvMRController();
                        $result = $viewDetails->doctorGetIndivMR($medicalrecordID);
                        if ($result->num_rows > 0) {
                            $row = $result->fetch_assoc();
                            echo "<form>".
                            "<div class='form-row'><br></br>".
                            "<div class='form-group col-md-8'>
                            <div style=font-size:22px;><b>MEDICAL RECORD ID : ".$row["medicalrecordID"].
                            "</b></div><br><b>Patient Information </b>" . 
                            "</div><div class='form-group col-md-6'><b>Name </b><br>" . $row["fullname"] . 
                            ...
                            echo "<div style='margin-top:150px;margin-left:280px;'><h4>No medical records found</h4></div>";
                        }
                        ?>
        </div>
    </div> 
